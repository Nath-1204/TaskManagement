import { ArrowRight, Calendar, FolderOpen, UserIcon } from 'lucide-react';
...
const ProjectOverview = () => {
  ...
  const statusColors = {
    PLANNING : "bg-zinc-200 text-zinc-800 dark:bg-zinc-600 dark:text-zinc-600 dark:text-zinc-200",
    ...
    CANCELED: "bg-red-200 text-red-800 dark:bg-red-500 dark:text-red-900"
  };
  ...
  return currentWorkspace && (
    <div className='bg-white dark:bg-zinc-950 dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 border border-zinc-200 
    dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-200 rounded-lg overflow-hidden'
    >
      <div className="border-b border-zinc-200 dark:border-zinc-800 p-4 flex items-center justify-between">
        <h2 className="text-md text-zinc-800 dark:text-zinc-300">Aperçu du projet</h2>
      ...
      <div className="p-0">
        {
          projects.length === 0 ? (
            <div className='p-12 text-center'>
              ...
              <p className="text-zinc-600 dark:text-zinc-400">Pas encore de projet</p>
              <button
                onClick={() => setIsDialogOpen(true)}
                className='mt-4 px-4 py-2 text-sm bg-gradient-to-br from-blue-600 text-white dark:text-zinc-200 rounded hover:opacity-90 trasition'
              >
                  ...
                  >
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-zinc-600 dark:text-zinc-400 line-clamp-2">
                          {project.description || 'Pas description'}
                        </p>
                      </div>
                      <div className="flex items-center gap-2 ml-4">
                        ...
                        <div className={`w-2 h-2 rounded-full border-2 ${priorityColors[project.priority]}`}></div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      <div className="flex items-center justify-between text-xs">
                        <span className='text-zinc-500 dark:text-zinc-500'>Progression</span>
                      ...
                      <div className="w-full bg-zinc-200 dark:bg-zinc-800 rounded h-1.5">
                        <div className='h-1.5 bg-blue-500 rounded' style={{ width: `${project.progress || 0}% `}}></div>
                      </div>
                    </div>
