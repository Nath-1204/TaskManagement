...
const typeIcons = {
  ...
  IMPORTANT: { icon: MessageSquare, color: "text-amber-500 dark:text-amber-400"},
...
const RecentActivity = () => {
  ...
  return (
    <div className="bg-white dark:bg-zinc-950 dark:bg-gradient-to-br dark:from-zinc-800/70 dark:to-zinc-900/50 
    border border-zinc-800 hover:border-zinc-300 dark:hover:bg-zinc-700 rounded-lg transition-all overflow-hidden"
    >
      <div className="border-b border-zinc-200 dark:border-zinc-800 p-4">
        <h2 className='text-lg text-zinc-800 dark:text-zinc-200'>Activité Récente </h2>
      </div>
      ...
      <div className="p-0">
        {
          tasks.length === 0 ? (
            <div className='p-12 text-center'>
              ...
              <p className="text-zinc-600 dark:text-zinc-400">Pas d'activité récente</p>
            </div>
          ) : (
                      ...
                      <div className="flex items-start gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex items-start justify-between mb-2">
                            ...
                            <span className={`ml-2 px-2 py-1 rounded text-xs ${statusColors[task.status] 
