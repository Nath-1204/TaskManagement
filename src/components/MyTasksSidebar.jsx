...
const MyTasksSidebar = () => {
  ...
  return (
    <div className="mt-6 px-3">
      <div onClick={toggleMyTasks} className="flex items-center justify-between px-3 py-2 rounded-lg ">
        <div className="flex items-center gap-2">
          <CheckSquareIcon className='w-4 h-4 text-gray-500 dark:text-zinc-400'/>
          <h3 className="text-sm font-medium text-gray-700 dark:text-zinc-300">Mes travails</h3>
                ...
                myTasks.length === 0 ? (
                  ...
                  myTasks.map((task, index) => (
                    <Link 
                      ...
                      className='w-full rounded-lg transition-all duration-200 text-gray-700 dark:text-zinc-300 
                      hover:bg-gray-100 dark:hover:bg-zinc-800 hover:text-black dark:hover:text-white'
                    >
