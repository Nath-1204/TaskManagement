    ...
    <div className="grid lg:grid-cols-2 gap-8">
      ...
      <div className={cardClasses}>
        ...
        <form onSubmit={handleSubmit} className='space-y-4'>
          ...
          >
            <Save className='size-4'/> {isSubmitting ? "Saving...." : "Save change"}
          </button>
      ...
      <div className="space-y-6">
        <div className={cardClasses}>
          <div className="flex items-center justify-between gap-4">
            <h2 className="text-lg font-medium text-zinc-900 dark:tetx-zinc-300 mb-4">
              Team Members <span className='text-sm text-zinc-600 dark:text-zinc-400'>
            ...
            >
              <Plus className='size-4 text-zinc-900 dark:text'/>
            </button>
