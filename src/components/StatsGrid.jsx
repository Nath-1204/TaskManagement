    ...
    const statCards = [
        {
            ...
            subtitle: `projets dans ${currentWorkspace?.name}`,
            bgColor: "bg-blue-500/10",
            textColor: "text-blue-500",
        },
        {
            icon: CheckCircle,
            title: "Projets Completé",
            value: stats.completedProjects,
            subtitle: `pour ${stats.totalProjects} total`,
        ...
        if (currentWorkspace) {
            setStats({
                ...
                completedProjects: currentWorkspace.projects
                    ...
                    .reduce((acc, project) => acc + project.tasks.lenght, 0),
      ...
      
      {
        statCards.map(
            ({ icon: Icon, title, value, subtitle, bgColor, textColor}, i) => (
                <div key={i} className='bg-white dark;bg-zinc-950 dark:bg-gradient-to-br dark:from-zinc-800/70 dark:tp-zinc-900/50 border border-zinc-200 dark:border-zinc-800 hover:border-zinc-300 dark:hover:border-zinc-700 transition duration-200 rounded-md'>
