import { ArrowRightIcon, CalendarIcon, ChartColumnIcon, ChevronRightIcon, KanbanIcon, SettingsIcon } from 'lucide-react';
  ...
  return (
    <div className='mt-6 px-3'>
      <div className="flex items-center justify-between px-3 py-2">
        ...
        <Link to="/projects">
          <button className='size-5 text-gray-500 dark:text-zinc-400 hover:text-gray-900 dark:hover:text-white 
          hover:bg-gray-100 dark:hover:bg-zinc-800 rounded flex items-center justify-center transition-colors duration-200'
          >
          ...
          projects.map((project) => (
            <div key={project.id}>
              <button 
                ...
                className='w-full flex items-center gap-2 px-3 py-2 rounded-lg transition-colors duration-200 text-gray-700 
                dark:text-zinc-300 hover:bg-gray-100 dark:hover:bg-zinc-800 hover;text-gray-900 dark:hover:text-white'
              >
                <ChevronRightIcon 
                      ...
                      getProjectSubItems(project.id).map((subItem) => {
                        ...
                        return (
                          <Link
                            ...
                            ${isActive ? 'bg-blue-100 text-blue-600 hover:bg-blue-200 dark:bg-blue-500/10 dark:text-blue-400 dark:hover:bg-blue-500/20'
