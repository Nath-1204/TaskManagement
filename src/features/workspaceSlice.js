    ...
    extraReducers: (builder) => {
        ...
        builder.addCase(fetchWorkspaces.fulfilled, (state, action)=>{
            ...
            if (action.payload.length > 0) {
                const localStorageCurrentWorkspacceId = localStorage.getItem('currentWorkspaceId');
                if (localStorageCurrentWorkspacceId) {
                  const findWorkspace = action.payload.find((w)=> w.id === localStorageCurrentWorkspacceId);
                  if (findWorkspace) {
...
export const { 
    ...
    addWorkspace, updateWorkspace, 
    deleteWorkspace, addTask,
